...
# -----------------------------------
# cargo run -- new-signers-file --artifact-signer-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_0.pub --artifact-signer-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_1.pub --artifact-signer-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_2.pub   -A 2 --master-key-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_3.pub --master-key-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_4.pub -M 1 -o ../../repo_for_e2e_tests/signers_update_by_master/signers_file_1.json
# cargo run -- new-signers-file --artifact-signer-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_5.pub --artifact-signer-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_6.pub --artifact-signer-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_7.pub   -A 2 --master-key-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_3.pub --master-key-file $PWD/../core/test_helpers/fixtures/keys/ed25519_key_4.pub -M 1 -o  ~/gits/asfaload/repo_for_e2e_tests/signers_update_by_master/signers_file_update_but_same_masters_ed25519.json
