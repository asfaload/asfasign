...
//!
//! Implements validated downloads per Asfaload spec Section 6:
//! 1. Fetch signers file from mirror
//! 2. Fetch asfaload.index.json from mirror
//! 3. Fetch signatures file from mirror
//! 4. Verify signatures meet artifact_signers threshold
//! 5. Download actual file from original source
//! 6. Compute and verify file hash
